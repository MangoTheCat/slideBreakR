...
#'
#' Wrapper to `splitTable` that splits a data frame into a a list and 
#' writes out markdown slides to be read in as a child document to 
#' main markdown file
#' 
...
#' 
#' @return Nothing in R.  A markdown document with the specified file name
#' 
#' @export
#' 
#' @examples {
